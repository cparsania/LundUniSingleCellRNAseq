D14 ventral scRNAseq data analysis
================
chirag parsania
11/20/2020
...
![](sc_rna_seq_data_analysis_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
We can see here that when PCA was run with cell cycle regression
